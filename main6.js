...
function setupEventListeners() {
    ...
    hint3Ok.addEventListener('click', () => hint3.classList.remove('visible'));

    // Add mouseenter/mouseleave listeners to UI elements to prevent scene clicks
...
function removePin(id) {
    ...
    renderPinList();
    isVibePinned = false; // Unlock vibe after removing a pin
}
